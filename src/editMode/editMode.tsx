...
const EditModeComponent = () => {
    ...
    const handleProfileTextareaKeyDown = (e: any) => {
        if (e.key === 'Enter') {
            e.preventDefault();
            handleSetProfile();
        }
    ...
    const handleCommentsTextareaKeyDown = (e: any) => {
        if (e.key === 'Enter') {
            e.preventDefault();
            handleAddComments();
        }
                ...
                <div className={s.editWindow}>
                    ...
                    <div className={s.cartContent}>
                        <div className={s.cartProfile}>
                            ...
                            <div >
                                {editElement && editElement.item.profile.length > 0 && isProfile
                                    ...
                                    : <div>
                                        <div ref={profileRef}>
                                            < textarea onKeyDown={handleProfileTextareaKeyDown} value={profileValue} onChange={(e) => setProfileValue(e.currentTarget.value)} onInput={adjustTextareaAddProfileHeight} id='profile' placeholder='Додати детальний опис...' className={s.cartProfileTextarea}></textarea>
                        ...
                        <div className={s.cartComment}>
                            ...
                            <div ref={commentRef}>
                                <textarea onKeyDown={handleCommentsTextareaKeyDown} value={commentValue} onChange={(e) => setCommentValue(e.currentTarget.value)} onInput={adjustTextareaAddCommentHeight} id='comment' placeholder='Написати коментар...' className={s.cartCommTextarea}></textarea>
